...
<style>
    ...
    .hero-bg h1 { font-size: 2rem; font-weight: 600; }
    ...
    .price-tag { color: #e62129; font-weight: 600; font-size: 0.9rem; }
    .route-text { font-size: 0.9375rem; font-weight: 600; color: #333; }
    .from-text { font-size: 0.8125rem; color: #6c757d; }
    
    .input-box { border: 1px solid #dee2e6; border-radius: 6px; padding: 8px 12px; background: #fff; }
    .label-mini { font-size: 0.6875rem; color: #6c757d; text-transform: uppercase; font-weight: 600; margin-bottom: 2px; letter-spacing: 0.02em; }
    .btn-search-red { background-color: #e62129; color: white; border: none; font-weight: 600; border-radius: 6px; font-size: 0.9375rem; }
    ...
    .footer-title { font-size: 1rem; font-weight: 600; margin-bottom: 20px; color: #333; }
    .footer-link { font-size: 0.875rem; color: #666; text-decoration: none; display: block; margin-bottom: 8px; }
